...
FactoryGirl.define do
  factory :ar_error_message, :class => '::RailsExceptionHandler::ActiveRecord::ErrorMessage' do
    ...
    user_info 'User Name'
    app_name 'Active Record Test App'
    doc_root '/var/www/testapp'
  end
  factory :ar_error_message_other_app, :class => '::RailsExceptionHandler::ActiveRecord::ErrorMessage' do
    class_name 'ActiveRecordTestClass'
    message "Unable to find local variable or method \"test\""
    trace "file1.rb:20\nfile2.rb:10\nfile3.rb:39"
    params "{:parameter => 'value'}"
    ...
    user_agent 'TestAgent'
    user_info 'User Name'
    app_name 'Active Record Other Test App'
    doc_root '/var/www/testapp'
  end
  factory :mg_error_message, :class => '::RailsExceptionHandler::Mongoid::ErrorMessage' do
    ...
    user_agent 'TestAgent'
    user_info 'User Name'
    app_name 'Mongoid Test App'
    doc_root '/var/www/testapp'
  end
  factory :mg_error_message_other_app, :class => '::RailsExceptionHandler::Mongoid::ErrorMessage' do
    class_name 'MongoidTestClass'
    message "Unable to find local variable or method \"test\""
    trace "file1.rb:20\nfile2.rb:10\nfile3.rb:39"
    params "{:parameter => 'value'}"
    ...
    user_agent 'TestAgent'
    user_info 'User Name'
    app_name 'Mongoid Other Test App'
    doc_root '/var/www/testapp'
  end
end
